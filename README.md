...
| `academic-writing` | `skills/academic-writing/` | Conference paper writing, venue-organized — systems venues (OSDI/NSDI/SIGCOMM/MOBICOM/SOSP/FAST) and AI/ML venues (AAAI/ICML/ICLR/NeurIPS): structure, format, citations, AAAI reproducibility checklist, ICML impact statement, ICLR public discussion, NeurIPS Paper Checklist + OpenReview rules |
